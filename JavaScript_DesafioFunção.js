...
function imprimir_numeros (num) {
    for (let i = 1; i <= num; i++) {
        console.log(i);
    }
}
imprimir_numeros(random);
...
console.log(`A hora atual e ${Hora_atual()}`)
...
//[ ] A prefeitura de uma cidade fez uma pesquisa entre seus habitantes, coletando dados sobre o salário e número de filhos. A prefeitura deseja saber: - média do salário da população; - média do número de filhos; - maior salário; 
...
//- Tempo em meses, que o valor está investidoA função deve RETORNAR a taxa de juros, já formatada. Ex: 2,5%. Siga a formula desse vídeo para te auxiliar com o cálculo.
